...
import { Restaurant } from "@/types/resturant.types";

const SearchPage = () => {
  // const params = useParams();
  const [searchQuery, setSearchQuery] = useState<string>("");
  const params = useParams();
  const {loading , appliedFilter , setAppliedFilter , searchRestaurant ,searchedRestaurant   } = useResturantStore()
      ...
      <div className=" flex flex-col  justify-between gap-10 ">
        ...
        <div className="flex-1">
          ...
          <Input
            type="text"
            value={searchQuery}
            placeholder="Search by restaurant and cusines"
        ...
        <div className="grid md:grid-cols-3 gap-4">
         ...
         ( searchedRestaurant?.data.map((restaurant: Restaurant) => (
            ...
            className=" max-w-sm bg-white bg-dark-gray-800 shadow-xl rounded-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300  ">
