import { NoResultFound } from "@/components/SearchPage";
    ...
    <div className="max-w-6xl mx-auto py-10 px-6">
      ...
      <div className="space-y-8">
        {/* Restaurant Orders diplay here  */}
         { (restaurantOrder && restaurantOrder.length > 0 )?  restaurantOrder.map((order) => (
...
)) :   <NoResultFound  searchText={"Orders not found"} />
        }
      </div>
    </div>
  );
